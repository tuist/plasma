...
Format pull request titles according to the [Conventional Commits](https://www.conventionalcommits.org/) convention without a scope. Use `refactor: harden runtime architecture`, not `refactor(plasma): harden runtime architecture`.
